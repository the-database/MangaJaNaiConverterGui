...
model, dirname, basename = load_model_node(r"\\WEJJ-II\traiNNer-redux\experiments\4x_MangaJaNai_V1RC26_OmniSR\models\net_g_40000.pth")
...
input_folder = r"D:\file\Boox Manga\この音とまれ！"
output_folder = r"D:\file\Boox Manga\この音とまれ！ 4x rc26 40k"
...
for filename in os.listdir(input_folder):
    if filename.lower().endswith('.zip'):
        ...
        output_zip_path = os.path.join(output_folder, filename)

        if os.path.isfile(output_zip_path):
            print(f"skip, {output_zip_path} exists")
            continue
                    ...
                    with input_zip.open(file_name) as file_in_zip:
                        ...
                        try:
                            with Image.open(io.BytesIO(image_data)) as img:
                                ...
                                Image.fromarray(upscaled_image).save(output_buffer, format="WEBP", quality=80)
