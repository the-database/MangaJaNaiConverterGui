...
input_zip_path = r"D:\file\同人誌\(C70) [ハウス オブ KARSEA (将司)] PRETTY NEIGHBOR&! 総集編 (よつばと!) autolevels.zip"
output_zip_path = r"D:\file\同人誌\(C70) [ハウス オブ KARSEA (将司)] PRETTY NEIGHBOR&! 総集編 (よつばと!) autolevels-rc26_34k.zip"
