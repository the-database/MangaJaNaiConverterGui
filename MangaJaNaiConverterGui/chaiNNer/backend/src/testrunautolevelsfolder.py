...
input_path = r"D:\file\画像\gallery-dl\reddit\DemonSchoolIrumakun\319"
output_path = r"D:\file\画像\gallery-dl\reddit\DemonSchoolIrumakun\319 rc29-40k"
...
for file_name in tqdm(os.listdir(input_path)):
    ...
    with Image.open(os.path.join(input_path, file_name)) as img:
        ...
        # print(image[199][501])
        image = upscale_image_node(image, model, ESTIMATE, False)
